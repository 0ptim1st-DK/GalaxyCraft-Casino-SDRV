...
function Images.diamond(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ АЛМАЗА
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ АЛМАЗА
    }
...
function Images.cherry(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ ВИШНИ
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ ВИШНИ
    }
    drawSprite(x, y, data, colors)
end
...
function Images.apple(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ ЯБЛОКА
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ ЯБЛОКА
    }
    drawSprite(x, y, data, colors)
end
...
function Images.banana(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ БАНАНА
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ БАНАНА
    }
    drawSprite(x, y, data, colors)
end
...
function Images.orange(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ АПЕЛЬСИНА
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ АПЕЛЬСИНА
    }
    drawSprite(x, y, data, colors)
end
...
function Images.seven(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ СЕМЁРКИ
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ СЕМЁРКИ
    }
    drawSprite(x, y, data, colors)
end
...
function Images.horseshoe(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ ПОДКОВЫ
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ ПОДКОВЫ
    }
    drawSprite(x, y, data, colors)
end
...
function Images.clover(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ КЛЕВЕРА
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ КЛЕВЕРА
    }
    drawSprite(x, y, data, colors)
end
...
function Images.coin(x, y)
    local data = {
        -- ВСТАВЬТЕ ВАШИ ДАННЫЕ ДЛЯ МОНЕТЫ
    }
    local colors = {
        -- ВСТАВЬТЕ ВАШИ ЦВЕТА ДЛЯ МОНЕТЫ
    }
    drawSprite(x, y, data, colors)
end
